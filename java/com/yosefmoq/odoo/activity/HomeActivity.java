...
import com.yosefmoq.odoo.databinding.ActivityHomeBinding;
import com.yosefmoq.odoo.fragment.AccountFragment;
import com.yosefmoq.odoo.fragment.EmptyFragment;
import com.yosefmoq.odoo.fragment.HomeFragment;
import com.yosefmoq.odoo.fragment.MenuFragment;
import com.yosefmoq.odoo.fragment.NotificationFragment;
import com.yosefmoq.odoo.handler.home.HomeActivityHandler;
...
import static com.yosefmoq.odoo.BuildConfig.DEFAULT_BACK_PRESSED_TIME_TO_CLOSE;
...
public class HomeActivity extends BaseActivity implements HomeListeners, OnTabSelectListener,/* OnTabReselectListener,*/FragmentManager.OnBackStackChangedListener, OnTabReselectListener {
...
//            if (AppSharedPref.isLoggedIn(this)) {
        ...
        }else if(tabId == R.id.navigation_bag){
            startActivity(new Intent(HomeActivity.this,BagActivity.class));
        }else if(tabId == R.id.navigation_menu){
            showMenuFrag();
        }
    }
...
//            Log.i(TAG, "showHomeFrag: 1");
        if (!mSupportFragmentManager.popBackStackImmediate(HomeFragment.class.getSimpleName(), 0)) { // fragment not in back stack, create it.
            ...
            FragmentHelper.replaceFragment(R.id.container, this, HomeFragment.newInstance(getIntent().getParcelableExtra(BUNDLE_KEY_HOME_PAGE_RESPONSE),this), HomeFragment.class.getSimpleName(), true, true);
        }
    }
...
//            Log.i(TAG, "showNotificationFrag: ");
            FragmentHelper.addFragment(R.id.container, this, NotificationFragment.newInstance(), NotificationFragment.class.getSimpleName(), true, true);
        }
    }

    private void showMenuFrag() {
        if (!mSupportFragmentManager.popBackStackImmediate(MenuFragment.class.getSimpleName(), 0)) { //fragment not in back stack, create it.
//            Log.i(TAG, "showAccountFrag: ");
            FragmentHelper.replaceFragment(R.id.container, this,  MenuFragment.newInstance(getIntent().getParcelableExtra(BUNDLE_KEY_HOME_PAGE_RESPONSE)), MenuFragment.class.getSimpleName(), true, true);
        }
    }
...
//            Log.i(TAG, "showAccountFrag: ");
            FragmentHelper.replaceFragment(R.id.container, this, AccountFragment.newInstance(getIntent().getParcelableExtra(BUNDLE_KEY_HOME_PAGE_RESPONSE)), AccountFragment.class.getSimpleName(), true, true);
        }
    }
...
//                                    ((AccountFragment) fragment).uploadFile(ImageHelper.getImageUri(getApplicationContext(), selectedImage));
                                    ...
                                    ((AccountFragment) fragment).uploadFile(imageData, false);
                                }
                            }
                        } else {
            ...
            case CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE:
                if (resultCode == RESULT_OK) {
                    ...
                    if (fragment != null && fragment.isAdded()) {
                        ...
                        ((AccountFragment) fragment).uploadFile(imageData, true);
//                            ((AccountFragment) fragment).uploadFile(ImageHelper.getImageUri(getApplicationContext(), (Bitmap) data.getExtras().get("data")));
                    }
                }
                break;
    ...
    @Override
    public void onNotificationClickListeners() {
        Log.v("ttt","Notification Click");
        showNotificationFrag();
